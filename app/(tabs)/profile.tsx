...
import { Settings, Bell, Heart, Chrome as Home, CircleHelp as HelpCircle, LogOut, ChevronRight } from 'lucide-react-native';
...
const menuItems = [
  { icon: Home, title: 'My Properties', subtitle: 'Manage your listings' },
  { icon: Heart, title: 'Saved Searches', subtitle: 'Your search criteria' },
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statItem}>
            ...
            <Text style={styles.statLabel}>Inquiries Sent</Text>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>RealEstate App v1.0.0</Text>
